            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#product">Productos Financiero</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#about">Informacion</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#priva">Aviso de Provacidad</a>
                    </li>
                    <li class="page-scroll">
    ...
    <section id="portfolio">
        <div class="container">
            <div class="row">
                ...
                <?php
                        $algo=DB::table('cms_categories')->where('id','1')->first();
                     echo $algo->resumen;
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        ...
                        <p>Calle 12 Poniente Norte 931-C<br>Barrio Juy Juy CP. 29038<br>Tuxtla Gutierrez, Chiapas, México.</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <h3>Siguenos</h3>
                    ...
                    <div class="footer-col col-md-4">
                        <h3>Telefonos</h3>
                        <p>Tel:(961) 618-1553 <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(961) 618-1554</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Soluciones y Oportunidades
                    </div>
                </div>
            </div>
        </div>
